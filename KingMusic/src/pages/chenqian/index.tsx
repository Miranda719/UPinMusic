...
import { Image, Avatar, List, Tabs, Modal, Toast, Popup, Button } from 'antd-mobile'
import { useRequest } from '@umijs/max';
import { CreateD, DeleteD, detailList, gedanD, UsermusicL } from '@/services';
          ...
          <Tabs.Tab title='收藏歌单' key='vegetables'>
            <ul className={styles.songs}>
              ...
              {!loading2 && shoucangm.map((item: any, index: number) => (
                ...
                <li key={item.id} onClick={() => goGedan(item.id)}>
